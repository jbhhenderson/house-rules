    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 14, 4, "Mow the Lawn" },
                    { 2, 2, 2, "Wash the Dishes" },
                    { 3, 30, 5, "Clean Out the Gutters" },
                    { 4, 1, 1, "Pick Up Living Room Clutter" },
                    { 5, 7, 3, "Laundry" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 4, new DateTime(2023, 9, 20, 12, 0, 0, 0, DateTimeKind.Unspecified), 1 });
